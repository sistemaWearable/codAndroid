...
public class actGraficoBatimento extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_act_grafico_batimento);

        setTitle("Grafico Batimento Cardiaco em bpm");
        barChart = findViewById(R.id.chartGraficoBatimento);

        dadosRecebidos = getIntent();
        if(dadosRecebidos.hasExtra("est2")){
            todasEstatisticas = (List<Estatistica>) dadosRecebidos.getSerializableExtra("est2");
            preencheValoresLista(todasEstatisticas);
            preencheGrafico();
        }
        else{
            Toast.makeText(actGraficoBatimento.this, "Nenhum dado foi recebido, por favor reinicie o aplicativo e tente novamente",
    ...
    private void preencheGrafico() {
        ...
        ArrayList<BarEntry> batimento = new ArrayList<>();
        batimento.add(new BarEntry(2, valorhora0));
        batimento.add(new BarEntry(4, valorhora2));
        batimento.add(new BarEntry(6, valorhora4));
        batimento.add(new BarEntry(0, valorhora6));
        batimento.add(new BarEntry(8, valorhora8));
        batimento.add(new BarEntry(10, valorhora10));
        batimento.add(new BarEntry(12, valorhora12));
        batimento.add(new BarEntry(14, valorhora14));
        batimento.add(new BarEntry(16, valorhora16));
        batimento.add(new BarEntry(18, valorhora18));
        batimento.add(new BarEntry(20, valorhora20));
        batimento.add(new BarEntry(22, valorhora22));

        BarDataSet barDataSet = new BarDataSet(batimento,"Batimento");
