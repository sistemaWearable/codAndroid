package tcc.com.br.tcc.asynctask.estatistica;
...
public class BaseEstatisticaAsyncTask<T> extends AsyncTask<Void, Void, T> {

    private final ExecutaListener<T> executaListener;
    private final FinalizadaListener<T> finalizadaListener;

    public BaseEstatisticaAsyncTask(ExecutaListener<T> executaListener,
